...
int main() {
    ...
    int width = 800 / nBox;
    sf::VertexArray particleBatch(sf::PrimitiveType::Points, nP);
    ...
    for (int index = 0; index < nP; index++) {
        ...
        particleBatch[index].color = sf::Color::Magenta;
        particleBatch[index].position = sf::Vector2f(particles[index].getX(), particles[index].getY());
