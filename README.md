...
A C++ simulation modeling gravitational and spring forces on particles in 2D space, with spatial partitioning for efficient collision detection and RK4 numerical integration for physics accuracy. SFML and OpenGL for rendering.
...
## Rendering
I used SFML to adhere with the industry standard and openGl to give the points a radius of 10 units.
The points are grouped a vector because it's faster that 1000 individual points. The simulation continues until the 'x' button on the rendering window is hit
...
https://github.com/user-attachments/assets/3a20db6b-6e33-470a-bff5-7009651d9068
